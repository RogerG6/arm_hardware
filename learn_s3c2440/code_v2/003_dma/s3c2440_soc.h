...
#define 			NFMECCD0				__REG(0x4E000014) 			//NAND flash main area ECC0/1
#define 			NFMECCD1				__REG(0x4E000018) 			//NAND flash main area ECC2/3
#define 			NFSECCD					__REG(0x4E00001C) 			//NAND flash spare area ECC
...
#define 			NFMECC0					__REG(0x4E00002C) 			//NAND flash main area ECC0 status
#define 			NFMECC1					__REG(0x4E000030) 			//NAND flash main area ECC1 status
#define 			NFSECC					__REG(0x4E000034) 			//NAND flash spare area ECC status
#define 			NFSBLK					__REG(0x4E000038) 			//NAND flash start block address
#define 			NFEBLK					__REG(0x4E00003C) 			//NAND flash end block address

//DMA
#define 			DISRC0					__REG(0x4B000000) 			//DMA 0 initial source register 
#define 			DISRC1					__REG(0x4B000040) 			//DMA 1 initial source register 
#define 			DISRC2					__REG(0x4B000080) 			//DMA 2 initial source register 
#define 			DISRC3					__REG(0x4B0000C0) 			//DMA 3 initial source register 
#define 			DISRCC0					__REG(0x4B000004) 			//DMA 0 initial source control register
#define 			DISRCC1					__REG(0x4B000044) 			//DMA 1 initial source control register
#define 			DISRCC2					__REG(0x4B000084) 			//DMA 2 initial source control register
#define 			DISRCC3					__REG(0x4B0000C4) 			//DMA 3 initial source control register
#define 			DIDST0					__REG(0x4B000008) 			//DMA 0 initial destination register
#define 			DIDST1					__REG(0x4B000048) 			//DMA 1 initial destination register
#define 			DIDST2					__REG(0x4B000088) 			//DMA 2 initial destination register
#define 			DIDST3					__REG(0x4B0000B8) 			//DMA 3 initial destination register
#define 			DIDSTC0					__REG(0x4B00000C) 			//DMA 0 initial destination control register
#define 			DIDSTC1					__REG(0x4B00004C) 			//DMA 1 initial destination control register
#define 			DIDSTC2					__REG(0x4B00008C) 			//DMA 2 initial destination control register
#define 			DIDSTC3					__REG(0x4B0000CC) 			//DMA 3 initial destination control register
#define 			DCON0					__REG(0x4B000010) 			//DMA 0 control register
#define 			DCON1					__REG(0x4B000050) 			//DMA 1 control register
#define 			DCON2					__REG(0x4B000090) 			//DMA 2 control register
#define 			DCON3					__REG(0x4B0000D0) 			//DMA 3 control register
#define 			DSTAT0					__REG(0x4B000014) 			//DMA 0 count register
#define 			DSTAT1					__REG(0x4B000054) 			//DMA 1 count register
#define 			DSTAT2					__REG(0x4B000094) 			//DMA 2 count register
#define 			DSTAT3					__REG(0x4B0000D4) 			//DMA 3 count register
#define 			DCSRC0					__REG(0x4B000018) 			//DMA 0 current source register
#define 			DCSRC1					__REG(0x4B000058) 			//DMA 1 current source register
#define 			DCSRC2					__REG(0x4B000098) 			//DMA 2 current source register
#define 			DCSRC3					__REG(0x4B0000D8) 			//DMA 3 current source register
#define 			DCDST0					__REG(0x4B00001C) 			//DMA 0 current destination register
#define 			DCDST1					__REG(0x4B00005C) 			//DMA 1 current destination register
#define 			DCDST2					__REG(0x4B00009C) 			//DMA 2 current destination register
#define 			DCDST3					__REG(0x4B0000DC) 			//DMA 3 current destination register
#define 			DMASKTRIG0				__REG(0x4B000020) 			//DMA 0 mask trigger register
#define 			DMASKTRIG1				__REG(0x4B000060) 			//DMA 1 mask trigger register
#define 			DMASKTRIG2				__REG(0x4B0000A0) 			//DMA 2 mask trigger register
#define 			DMASKTRIG3				__REG(0x4B0000E0) 			//DMA 3 mask trigger register
