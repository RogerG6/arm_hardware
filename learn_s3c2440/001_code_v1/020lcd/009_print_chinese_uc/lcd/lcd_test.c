...
//在屏幕中显示线、圆
		...
		draw_line( xres - 1, 0, xres - 1, yres - 1, 0x12);
		draw_line(xres - 1, yres - 1, 0, yres - 1, 0xff);
		draw_line(0, 0, yres - 1, 0, 0xff);
		draw_line(0, 0, xres - 1, yres - 1, 0xff);
		draw_line(0, yres - 1, xres - 1, 0, 0x7a);	
...
//在屏幕中写字
    	...
    	put_font(10, 10, "www.baidu.com", 0xff);
	
//=====================================================
//在屏幕中写汉字

		put_chinese(10, 30, "郭良权", 0xff);
}
