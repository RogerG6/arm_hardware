...
/* SPI */
#define SPCON0  	(*(volatile unsigned long*)0x59000000) // SPI channel 0 control register
#define SPCON1 		(*(volatile unsigned long*)0x59000020) // SPI channel 1 control register
#define SPSTA0  	(*(volatile unsigned long*)0x59000004) // SPI channel 0 status register
#define SPSTA1  	(*(volatile unsigned long*)0x59000024) // SPI channel 1 status register
#define SPPIN0		(*(volatile unsigned long*)0x59000008)	//SPI channel 0 pin control register
#define SPPIN1		(*(volatile unsigned long*)0x59000028)	//SPI channel 1 pin control register
#define SPPRE0		(*(volatile unsigned long*)0x5900000C)	//SPI channel 0 baud rate prescaler register
#define SPPRE1		(*(volatile unsigned long*)0x5900002C)	//SPI channel 1 baud rate prescaler register
#define SPTDAT0		(*(volatile unsigned char*)0x59000010)	//SPI channel 0 Tx data register
#define SPTDAT1		(*(volatile unsigned char*)0x59000030)	//SPI channel 1 Tx data register
#define SPRDAT0		(*(volatile unsigned char*)0x59000014)	//SPI channel 0 Rx data register
#define SPRDAT1		(*(volatile unsigned char*)0x59000034)	//SPI channel 1 Rx data register
